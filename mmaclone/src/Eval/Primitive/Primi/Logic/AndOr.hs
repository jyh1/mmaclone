module Eval.Primitive.Primi.Logic.AndOr(andl, orl) where
...
andl,orl :: EvalPrimi
-- | in order to implement short circut evaluation,
-- require a Eval argument to evaluate expression internally
andl eval ls =
